...
const SubscriptionSection = () => {
  ...
  return (
    <section className=" bg-secondary-background w-full flex flex-col items-center justify-center py-20 px-6 md:px-10 2xl:px-[135px] gap-8">
      <div className="max-w-[1170px] w-full bg-background rounded-3xl py-16 px-4 md:px-6  text-white flex flex-col items-center gap-8">
        <div className="flex flex-col gap-4 text-center">
          <h2 className="font-bold text-[min(10vw,36px)]">
