...
const CompetitionForm = () => {
  return (
    ...
    <form className="w-full max-w-[687px] px-8 py-10 flex flex-col gap-6 bg-gradient-to-b from-[#ffffff] dark:from-[#0F172A] border-3 border-bg-border rounded-2xl  shadw-lg">
