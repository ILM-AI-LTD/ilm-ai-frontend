        ...
        return (
            <div className="h-full w-full flex items-center justify-center">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-foreground text-lg">Loading data…</p>
                </div>
            </div>
        )
    }
    ...
    return (
        ...
        <div className="h-full max-w-[1770px] w-full flex flex-col py-5">
            <div className="flex-1 flex flex-col overflow-auto">
                ...
                <div className="flex flex-col items-center gap-4">
                    <div className="text-center text-foreground flex flex-col items-center gap-4">
                        <CircleCheck size={60} color="white" strokeWidth={.5} className='bg-primary rounded-full' />
                        <h1 className="font-bold text-[min(6vw,32px)]">
                            Timetable Sent Successfully!
                        </h1>
                        <p className="font-normal text-[min(10vw,18px)] text-muted-foreground">
                            We have sent the full schedule as a PDF to your email.
                        </p>
                    </div>

                    <div className="w-full mb-4">
                        <h1 className="font-semibold text-foreground text-[min(5vw,22px)]">
                            Child's Weekly Timetable Summary
                        </h1>
                        <p className="text-base text-foreground py-4 border-b border-primary">
                        ...
                        <CustomButton
                            ...
                            variant="default"
                            className='rounded-3xl mt-4 py-6 transition ease-in-out font-semibold'
