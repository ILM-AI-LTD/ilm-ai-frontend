            ...
            <div className="flex-1 flex flex-col overflow-auto">
                ...
                <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="w-full mb-4">
                        ...
                        <p className="text-base text-white py-4 border-b border-brand-color-parent">
                        ...
                        <CustomButton
                            ...
                            className="bg-brand-color-parent text-white rounded-3xl mt-4 py-6 hover:bg-brand-color-parent/80 transition ease-in-out"
