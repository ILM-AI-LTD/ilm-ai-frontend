...
export default function AuthLayout({
  ...
  return (
    <div className="min-h-screen w-full relative overflow-hidden bg-background">
      <div className="absolute h-full w-full bg-[radial-gradient(#5a5f66_1px,transparent_1px)] [background-size:28px_28px] [mask-image:radial-gradient(ellipse_50%_50%_at_50%_50%,#000_5%,transparent_100%)]"></div>
