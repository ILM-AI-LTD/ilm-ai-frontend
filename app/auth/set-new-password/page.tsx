            ...
            <Card className="w-full p-5 md:p-10 rounded-[20px] flex flex-col gap-6 bg-secondary border-none shadow-none">
                ...
                <CardHeader className="p-0 space-y-0 flex flex-col gap-6 justify-center items-center">
                    ...
                    <div className="text-center flex flex-col gap-2">
                        <CardTitle className="text-2xl font-semibold text-foreground">Create new password</CardTitle>
                        <CardDescription className="font-normal text-base text-muted-foreground">Your identity has been verified! Set your new password.</CardDescription>
                    </div>
                </CardHeader>
